...
class Setup:
    ...
    def __init__(self):
        print("Ansible not found, installing Docker manually,")
    ...
    def install_docker(self):
        ...
        """
        logger.info("[+] Installing Docker and necessary supporting plugins")
        logger.info("[+] This could take some time. Please wait ...")
        try:
            ...
            try:
                ...
                logger.install_log('Installation Error: \n' +
                                         str(exception))
